...
public final class AeTerminalRemovalInvalidationGameTest {
    private AeTerminalRemovalInvalidationGameTest() {
    }
    ...
    public static void aeTerminalRemovalInvalidatesMenuContextAndClearsJobs(GameTestHelper helper) {
        GameTestRuntimeLease.runWhenAvailable(helper,
                () -> AeCraftLifecycleIsolationGameTestScenarios.terminalRemovalInvalidatesMenuContextAndClearsJobs(
                        helper,
                        AeTerminalRemovalInvalidationGameTest::createPlayer
                ));
    }
